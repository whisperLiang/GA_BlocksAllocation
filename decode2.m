...
function [PCB, NPC, violate_num_pc, violate_r11,violate_r22,violate_r33,violate_r44, ...
    sviolate_blocks_shuju,sviolate_blocks_kongzhi] = decode2(chrom, block_number,attachment1_date,attachment3_date,M_constrain_shuju,M_acess)
  violate_num_pc = 0;
  violate_r11 = 0;
  violate_r22 = 0;
  violate_r33 = 0;
  ...
  for j=1:NPC
    ...
    route = route{1};
    [flag, violate_r1, violate_r2, violate_r3, violate_r4] = Judge_resource2(route,attachment1_date,M_acess);
  ...
  violated_pc5 = Judgecontrain25(PCB,attachment1_date,NPC,M_acess);
